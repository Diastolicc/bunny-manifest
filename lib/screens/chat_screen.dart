...
class _ChatScreenState extends State<ChatScreen> {
  static const double _surfaceRadius = 36;
  String _searchQuery = '';
  ...
  Widget _buildSearchBarCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppTheme.colors.primary.withOpacity(0.06),
            blurRadius: 16,
    ...
    try {
      ...
      for (var doc in messagesSnapshot.docs) {
        ...
        if (data.containsKey('readBy')) {
          final readBy =
              List<String>.from(data['readBy'] as List<dynamic>? ?? []);
      ...
      if (jsonList != null && jsonList is List) {
        return jsonList
            .map((item) => ChatGroup(
                  ...
                  lastMessageTime:
                      DateTime.tryParse(item['lastMessageTime'] ?? '') ??
                          DateTime.now(),
  ...
  Future<void> _deleteConversation(
      BuildContext context, ChatGroup group) async {
    try {
          ...
          background: Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [Color(0xFFFF5B5B), Color(0xFFFF7A7A)],
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppTheme.colors.primary.withOpacity(0.07),
                    blurRadius: 16,
                    offset: const Offset(0, 6),
                  ),
                ],
